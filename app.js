...
console.log( x1 == x4);
// tugas 2 => jika tugas 1 bernilai false, buat agar saat perbandingan x1 bernilai true saat dibandingkan dengan x4 [boleh menggunakanaritma x1 >= 10 || x1 >= 10 || x1 >= 10 || x1 >= 10 || x1 >= 10tika]
let benar = x1 < x4;
console.log(benar);
...
if(x2 == x4) {
  console.log(`Perbandingan nilai x2 yang bernilai ${x2} dengan x4 yang bernilai ${x4} adalah ${x2 == x4} `)
}
...
if(x1 > 10) {
  ...
  console.log(`Anda lebih besar daripada semua`)
}
...
if(x1 < 1) {
  ...
  console.log(`Tidak ada variable yang memiliki nlai kecil dari 1`)
}
